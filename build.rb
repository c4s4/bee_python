...
def generate_tasks_reference(rdoc_tasks_reference)
  methods = Bee::Task::Python.instance_methods(false)
  rdoc = "Here is the reference for Bee Python tasks:\n\n"
  for method in methods.sort
    comment = Bee::Task::Python.method_info(method).comment
    rdoc << "== #{method}\n\n"
    rdoc << "#{comment}\n\n"
  end
  rdoc.strip!
...
def generate_templates_reference(rdoc_templates_reference)
  ...
  rdoc = "Here is the list of available Python project templates. You can 
